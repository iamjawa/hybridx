  ...
  if (sent) {
    return (
      <div className="rounded-lg border bg-muted/50 p-6 text-center space-y-2">
        ...
        <p className="text-xs text-muted-foreground">A magic link has been sent. You can close this tab.</p>
      </div>
    )
  }
  ...
  return (
    <div className="space-y-4">
      <a
        ...
        className="inline-flex h-10 w-full items-center justify-center gap-2 rounded-lg border bg-background px-4 text-sm font-medium hover:bg-muted transition-colors"
      >
